...
\ac{B10} - Scientific Productivity\\
\ac{B11} - Reproducibility and Replicability of Computation\\
\ac{B6} - Data Management\\
\ac{B7} - Exascale Algorithms\\
\end{tabular} \\
        \bottomrule
    \end{tabular}
    }}
...
\rowcolor{white}    \ac{B10} - Scientific Productivity & provide short description here \\
\rowcolor{numpexlightergray}    \ac{B11} - Reproducibility and Replicability of Computation & provide short description here \\
\rowcolor{white}    \ac{B6} - Data Management & provide short description here \\
\rowcolor{numpexlightergray}    \ac{B7} - Exascale Algorithms & provide short description here \\
\end{tabular}
        }
    }
