...
\label{sec:Freefem++:apps}
FreeFEM is used in several applications described in Chapter~\ref{chap:applications}:
\begin{itemize}
        \item Parallel mesh adaptation with ParMMG (extended mini‑app): Section~\ref{sec:app:specs:app-freefem-parmmg}.
        \item Proposed shape optimization with FEM: Section~\ref{sec:app:specs:app-freefem-shape-opt-fem}.
\end{itemize}
