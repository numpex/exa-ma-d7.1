...
We provide initial performance metric of the two relevant discretization algorithms.
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.6\textwidth]{figures/fan.png} %PLACEHOLDER christos-todo
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=0.6\textwidth]{figures/refinement_speedup.png} %PLACEHOLDER christos-todo 
