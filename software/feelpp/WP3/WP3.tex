...
The benchmark has been described in the prequel of this document, in \Cref{sec:WP1:Feelpp:benchmark4}.

description rapide du solveur et du preconditioner

pb mutliphysique avec point selle
