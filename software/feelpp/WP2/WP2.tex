...
\begin{table}
    ...
    \begin{tabular}{!{\color{numpexgray}\vrule}rl!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}c!{\color{numpexgray}\vrule}}
        ...
        \rowcolor{numpexgray}
        \multicolumn{2}{c}{}                                  & \color{white}\bf \texttt{np = 12} & \color{white}\bf \texttt{np = 64}   & \color{white}\bf \texttt{np = 128} & \color{white}\bf \texttt{np = 12} & \color{white}\bf \texttt{np = 12} & \color{white}\bf \texttt{np = 128} \\
        \rowcolor{numpexlightergray}
        Fine snapshots         & $u_h^\mathcal{N}$            & \qty{13.6}{\second}     & \qty{4.79}{\second} & \qty{2.38e+00}{\second} & --   & 2.84  & 5.71 \\
        Coarse snapshots       & $u_H^\mathcal{N}$            & \qty{2.77e+00}{\second} & \qty{1.10}{\second} & \qty{0.859}{\second}    & 4.90 & 12.36 & 15.83 \\
        \rowcolor{numpexlightergray}
        NIRB w/o rectification & $u_{Hh}^{N,\text{NoRect}}$   & \qty{3.190}{\second}    & \qty{1.309}{\second} & \qty{1.0687}{\second}   & 4.26 & 10.39 & 12.73 \\
        NIRB w/ rectification  & $u_{Hh}^{N,\text{Rect}}$     & \qty{3.203}{\second}    & \qty{1.311}{\second} & \qty{1.0691}{\second}   & 4.25 & 10.37 & 12.72 \\
        \hline
    \end{tabular}}
