...
\newcommand{\barChart}[3][ybar]{
  \begin{tikzpicture}
    ...
    \foreach [expand list=true] \thetuple in {#3} {
...
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M3_P1_discoverer.csv}\dataThermalBridgesMcPaDiscoverer
...
\begin{figure}
  \centering
  \def\plotSetup{
    {legend=Init,column=init,color=customdarkblue},
    {legend=Assembly,column=algebraic-assembly,color=customcyan},
    {legend=Solve,column=algebraic-solve,color=customorange},
    {legend=PostProcess,column=exportResults,color=custompurple}
  }
  \begin{subfigure}[c]{0.49\textwidth}
    \centering
    \barChart[ybar]{\dataThermalBridgesMcPaDiscoverer}{\plotSetup}
    \caption{\texttt{M3} - \texttt{$P_1$}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[c]{0.49\textwidth}
    \centering
    \barChart[ybar stacked]{\dataThermalBridgesMcPaDiscoverer}{\plotSetup}
    \caption{\texttt{M3} - \texttt{$P_1$}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[c]{0.49\textwidth}
    \centering
    \barChart[ybar]{\dataThermalBridgesMcPbDiscoverer}{\plotSetup}
    \caption{\texttt{M3} - \texttt{$P_2$}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[c]{0.49\textwidth}
    \centering
    \barChart[ybar stacked]{\dataThermalBridgesMcPbDiscoverer}{\plotSetup}
    \caption{\texttt{M3} - \texttt{$P_2$}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[c]{0.49\textwidth}
    \centering
    \barChart[ybar]{\dataThermalBridgesMcPcDiscoverer}{\plotSetup}
    \caption{\texttt{M3} - \texttt{$P_3$}}
  \end{subfigure}
  \hfill
  \begin{subfigure}[c]{0.49\textwidth}
    \centering
    \barChart[ybar stacked]{\dataThermalBridgesMcPcDiscoverer}{\plotSetup}
    \caption{\texttt{M3} - \texttt{$P_3$}}
  \end{subfigure}
\end{figure}
