...
\foreach [expand list=true] \meshId in {1} {
  ...
  \pgfplotstableread[col sep=comma]{\currfiledir/data/HL-31_M\meshId_P1_gaya.csv}\dataPa
  \pgfplotstableread[col sep=comma]{\currfiledir/data/HL-31_M\meshId_P2_gaya.csv}\dataPb
