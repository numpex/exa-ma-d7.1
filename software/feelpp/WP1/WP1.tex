...
In terms of performance, we have plotted the execution times related to the WP1 context. These results, illustrating the  \textbf{Init}, \textbf{Assembly} and \textbf{post-process} components, can be found in
