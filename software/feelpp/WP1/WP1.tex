...
%   \begin{subfigure}[c]{0.49\textwidth}
%     \centering
%     \includegraphics[width=\textwidth]{graphics/feelpp/feelpp-benchmark-nafems-le10-solution-tresca-wrap.png.png}
%   \end{subfigure}
...
\label{fig:feelpp:wp1:nafems-le10:measures_convergences}
...
A more detailled version of the full model is available in Daversion2016. The model is run with \testtt{thermoelectric} \Feelpp toolbox. 
...
%\foreach [expand list=true] \meshId in {1} {
  ...
  \begin{figure}
    ...
    \label{fig:feelpp:wp1:hl-31:performance_times_M\meshId}
  \end{figure}
