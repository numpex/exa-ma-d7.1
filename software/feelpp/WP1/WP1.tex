...
solution of an elliptic linear equation (i.e. the heat equation). We employ a
...
\item \textbf{PostProcess}: compute validation measure (temperature at points and
...
\item \textbf{Input Data:}
  ...
  \item Meshes: We have generated three levels of mesh called M1, M2
    ...
    \Cref{tab:wp3:feelpp:thermal_bridges:discr_stat}. We have also prepared for
...
\begin{table}[h!]
  ...
  \label{tab:wp3:feelpp:thermal_bridges:discr_stat}
\end{table}
...
discussion in appropriate section ???.
...
Communication an IO effect is non-negligible.
...
more accurately in a next campaign of these benchamrking test.
  ...
  \begin{tikzpicture}
    ...
    \foreach [expand list=true] \thetuple in {#2} {
      ...
      \edef\temp{
        ...
        table [x expr=\noexpand\coordindex, y=\mycolumn ] {\expandafter\noexpand\csname \mytable\endcsname};
      } \temp
...
\foreach [expand list=true] \meshId in {1,2,3} {
  ...
  \begin{figure}
    ...
    \def\chartBarPlot##1##2{
      \barChart[ybar,xticklabels from table={##2}{nProc}]{\plotSetup{##1}}
    }
    \def\chartBarStackedPlot##1##2{
      \barChart[ybar stacked,xticklabels from table={##2}{nProc}]{\plotSetup{##1}}
    }

    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      %\barChart[ybar,xticklabels from table={\dataPa}{nProc}]{\plotSetup{dataPa}}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      %\barChart[ybar stacked]{\plotSetup{dataPa}}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      %\barChart[ybar]{\plotSetup{dataPb}}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      %\barChart[ybar stacked]{\plotSetup{dataPb}}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      %\barChart[ybar]{\plotSetup{dataPc}}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      %\barChart[ybar stacked]{\plotSetup{dataPc}}
      \chartBarStackedPlot{dataPc}{\dataPc}
      \caption{\texttt{M\meshId} - \texttt{$P_3$}}
    \end{subfigure}
    \caption{Benchmarks performance results by using mesh \texttt{M\meshId} on
      Discoverer}
...
\begin{itemize}
    \item \textbf{Memory Usage:} We need to check and detect the memory
      consuming during the simulation to avoid bad behavior like swapping.
...
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M1_P1_discoverer.csv}\dataMaPa
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M1_P2_discoverer.csv}\dataMaPb
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M1_P3_discoverer.csv}\dataMaPc
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M2_P1_discoverer.csv}\dataMbPa
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M2_P2_discoverer.csv}\dataMbPb
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M2_P3_discoverer.csv}\dataMbPc
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M3_P1_discoverer.csv}\dataMcPa
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M3_P2_discoverer.csv}\dataMcPb
\pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M3_P3_discoverer.csv}\dataMcPc
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      ...
      \begin{axis}[
        ...
        \addplot[color=customdarkblue,dashdotdotted,mark=o,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMaPa};
        \addlegendentry{M1-P1}
        \addplot[color=customdarkblue,dashed,mark=o,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMaPb};
        \addlegendentry{M1-P2}
        \addplot[color=customdarkblue,mark=o,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMaPc};
        \addlegendentry{M1-P3}
        \addplot[color=customcyan,dashdotdotted,mark=triangle,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMbPa};
        \addlegendentry{M2-P1}
        \addplot[color=customcyan,dashed,mark=triangle,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMbPb};
        \addlegendentry{M2-P2}
        \addplot[color=customcyan,mark=triangle,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMbPc};
        \addlegendentry{M2-P3}
        \addplot[color=customorange,dashdotdotted,mark=square,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMcPa};
        \addlegendentry{M3-P1}
        \addplot[color=customorange,dashed,mark=square,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMcPb};
        \addlegendentry{M3-P2}
        \addplot[color=customorange,mark=square,line width=\myLineWidth] table [x=nProc, y=ksp-niter] {\dataMcPc};
  ...
  \foreach [expand list=true] \polyId in {1,2,3} {
    ...
    \pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M1_P\polyId_discoverer.csv}\dataMa
    \pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M2_P\polyId_discoverer.csv}\dataMb
    \pgfplotstableread[col sep=comma]{\currfiledir/data/thermalbridges_M3_P\polyId_discoverer.csv}\dataMc
...
\caption{Benchmarks performance results  on  Discoverer}
\end{figure}
