...
\foreach [expand list=true] \meshId in {1,2,3} {
  ...
  \begin{figure}
    ...
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      \barChart[ybar]{\dataPa}{\plotSetup}
      \caption{\texttt{M\meshId} - \texttt{$P_1$}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      \barChart[ybar stacked]{\dataPa}{\plotSetup}
      \caption{\texttt{M\meshId} - \texttt{$P_1$}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      \barChart[ybar]{\dataPb}{\plotSetup}
      \caption{\texttt{M\meshId} - \texttt{$P_2$}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      \barChart[ybar stacked]{\dataPb}{\plotSetup}
      \caption{\texttt{M\meshId} - \texttt{$P_2$}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      \barChart[ybar]{\dataPc}{\plotSetup}
      \caption{\texttt{M\meshId} - \texttt{$P_3$}}
    \end{subfigure}
    \hfill
    \begin{subfigure}[c]{0.49\textwidth}
      \centering
      \barChart[ybar stacked]{\dataPc}{\plotSetup}
      \caption{\texttt{M\meshId} - \texttt{$P_3$}}
    \end{subfigure}
