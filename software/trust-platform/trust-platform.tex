...
\begin{itemize}
   \item \fullcite{calvin_object-oriented_2002} is the original paper for the Trio_U platform, previous name of TRUST, describing the C++ choices and parallel capabilities for the code.
