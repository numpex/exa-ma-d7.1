...
\begin{equation} \label{eq:minproblem}
 \hat{x} \in \argmin_{x \in \mathcal{S}}f(x) 
\end{equation}
...
Thomas Firmin, El-Ghazali Talbi, Massively Parallel Asynchronous Fractal Optimization. IEEE IPDPS Workshops PDCO (13th IEEE Workshop Parallel / Distributed Combinatorics and Optimization), pp.930-938, Florida, USA, 2023.

Thomas Firmin, El-Ghazali Talbi, A Comparative Study of Fractal-Based Decomposition Optimization. OLA 6th Int. Conf. on Optimization and Learning, Malaga, Spain, Proceedings. Communications in Computer and Information Science 1824, Springer 2023, pp.3-20, May 2023.
