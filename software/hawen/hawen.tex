...
Recently, it has been updated to better use GPU, with preliminary
results reported in \cite{Occhipinti2025}.
...
\begin{itemize}
\item \cite{hal_05393820}: 3D simulations of gravito-acoustic waves in the Sun up to the photosphere.
...
\item \cite{Liu2024,Benitez2024}: 
      ...
      for benchmarks.
\item \cite{Occhipinti2025}: In this Master thesis, we start the implementation
      of GPU features for \hawen~to better use hybrid architectures.
\end{itemize}
