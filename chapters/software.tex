...
The charts in this section retain the previous catalogue snapshot.
They have not yet been recomputed to include the newly registered FUnTiDES
framework (Section~\ref{sec:FUnTiDES:software}).
...
\input{software/funtides/funtides.tex}
...
\begin{itemize}
    ...
    \item \textbf{FUnTiDES}: framework registered; no Exa-MA application or benchmark association yet. See Section~\ref{sec:FUnTiDES:software}.
