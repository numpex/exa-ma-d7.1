...
\begin{table}[ht]
    ...
    \begin{tblr}{
        ...
        metrics & \todo{Missing in operational Sheet; resolve against the versioned I/O results.} \\
        status & \todo{Missing in operational Sheet.} \\
        Benchmark scope & \todo{Missing in operational Sheet.} \\
