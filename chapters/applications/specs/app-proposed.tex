...
\noindent\textbf{v2.90.0 review note.} Identity, ownership, WP mapping and status
must be checked against \Cref{tab:v3-application-registry}.  Dates and phases
below are inherited v2 planning statements, not completed 2026 achievements.
...
\subsubsection{app-freefem-shape-opt-fem: Shape Optimization with FEM}
\label{sec:app:specs:app-freefem-shape-opt-fem}
