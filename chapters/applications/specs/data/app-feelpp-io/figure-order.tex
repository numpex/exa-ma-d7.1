...
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/loadMesh128.csv}\dataLoadMesh
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/functionSpace128.csv}\dataFunctionSpace
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/functionSpaceV128.csv}\dataFunctionSpaceV
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/saveMesh128.csv}\dataSaveMesh
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/exportData128.csv}\dataExportData
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/exportField128.csv}\dataExporField
\pgfplotstableread[col sep=comma]{chapters/applications/specs/data/app-feelpp-io/exportFieldV128.csv}\dataExporFieldV
...
\begin{figure}
  \begin{subfigure}[c]{0.49\textwidth}
    ...
    \begin{axis}[
      ...
      xlabel={ Order of discretization }, ylabel={ Time [s] },
      xtick=data, xtick align=outside,
      ymode=log,
      ymajorgrids=true, yminorgrids=true,
      xmajorgrids=true,
      xticklabels from table={\dataLoadMesh}{discretization},
  ...
  \begin{subfigure}[c]{0.49\textwidth}
    ...
    \begin{axis}[
      ...
      ymajorgrids=true, yminorgrids=true,
      xmajorgrids=true,
      xticklabels from table={\dataSaveMesh}{discretization},
      cycle list name=color list,
      legend style={at={(0.99,0.99)}, anchor=north east}
    ]
  ...
  \begin{subfigure}[c]{0.49\textwidth}
    ...
    \label{fig:specs:app-feelpp-io:disc:functionspaceV}
  \end{subfigure}
    ...
    \label{fig:specs:app-feelpp-io:disc:exportfield}
  \end{subfigure}
  \begin{subfigure}[c]{0.33\textwidth}
    \centering
    \begin{tikzpicture}
    ...
    \label{fig:specs:app-feelpp-io:disc:exportfieldv}
  \end{subfigure}
  \begin{subfigure}[c]{0.33\textwidth}
    \centering
    \begin{tikzpicture}
  ...
  \caption{Profiling times for the mini-app \texttt{app-feelpp-io}, run on Gaya, at fixed a number of parallel tasks ($\texttt{np}=128$).
  The colors of the plots correspond to the mesh used, as described in the legend of \Cref{fig:specs:app-feelpp-io:disc:savemesh}.}
