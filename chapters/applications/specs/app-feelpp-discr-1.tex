...
This benchamrk was performed on the Gaya cluster of the University of Strasbourg, using feelpp.benchmarking v4.0.0.
...
The thermal bridges benchmark has been executed on the Gaya supercomputer at Unistra for the three mesh refinement levels (M1, M2, M3) using finite element approximations of order 1, 2, and 3.
