...
\textcolr{blue}{fromLN: je suggère plutôt: This work package proposes an extensive list of tasks that are relevant when dealing with the two above topics. Here is a list followed by a description when it is actually addressed with financial support of Exa-MA.}
\begin{itemize}
