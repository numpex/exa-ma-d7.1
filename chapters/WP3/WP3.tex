...
% D7.1 V3 / v2.90.0 -- WP3 CONTRIBUTION
%
...
\label{sec:wp3-main-advances-2026}
...
% Duplicate this record in WP3.tex for each main 2026 advance and replace the
% compact field cues with factual entries.  Do not edit the central table style.
\begin{WPAdvanceRecord}{WP3-A2026-1}
Exa-MA task and bottleneck & \WPFieldHint{T3.x; Bx} \\
...
\WPUpdateNote{Update the inherited solver advances with the work performed in
...
In this respect, this work is also very closely related to \Cref{sec:wp3:T32}. 
...
\begin{itemize}
  ...
  \item Composyx: % (en attente de Luc)
...
\WPUpdateNote{Reconcile this mapping with the application and benchmark
registries, retaining explicit gaps where no justified link exists.}
...
\begin{itemize}
  ...
  \item PROMISE (precision auto-tuning): Composyx/Maphys++ context in Section~\ref{sec:Composyx:software} or WP3 text above.
\end{itemize}
  	extbf{Benchmarks}
\begin{itemize}
