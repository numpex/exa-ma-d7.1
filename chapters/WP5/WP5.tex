...
% D7.1 V3 / v2.90.0 -- WP5 CONTRIBUTION
%
...
\label{sec:wp5-main-advances-2026}
...
% Duplicate this record in WP5.tex for each main 2026 advance and replace the
% compact field cues with factual entries.  Do not edit the central table style.
\begin{WPAdvanceRecord}{WP5-A2026-1}
Exa-MA task and bottleneck & \WPFieldHint{T5.x; Bx} \\
...
\WPUpdateNote{Update the inherited optimization advances with the work performed
in 2026.  Separate new achievements from the earlier baseline and cite the
...
\begin{itemize}
	...
	\item Shape optimization with FEM (FreeFEM, proposed): Section~\ref{sec:app:specs:app-freefem-shape-opt-fem}.
\end{itemize}
