...
\usepackage{geometry}
% Fix fancyhdr warnings - use recommended values from compilation output
...
\hypersetup{
	pdftitle={Exa-MA v2.90.0 integration draft for v3.0.0},
...
\delivNumber{D1.1; D1.3; D2.1; D2.3; D3.1; D3.3; D4.1; D4.3;
  D5.1; D5.3; D6.1; D6.3; D7.1; D7.3}
\delivFooterLabel{Mega-deliverable D1--D7}

\delivName{Methodology, Application Framework and Benchmarking Analysis Report\\[0.8ex]
\textit{v2.90.0 integration draft -- final target v3.0.0, 14 October 2026}}

% DOI Number (will be provided by the coordinator)
\doiNumber{10.5281/zenodo.15188286} % leave empty if no DOI Number is provided

% Deliverable Short Title
\delivShortTile{BAR -- v3 integration draft}
...
\delivVersion{v2.90.0}
\ContractualDate{14/10/2026 (final v3.0.0)}
\ActualDate{23/07/2026 (integration draft)}
...
\delivFPAuthor{[Pierre Alliez (Inria), Hélène Barucq (Inria), Victor Dansac (Inria), Vincent Faucher (CEA), Emmanuel Franck (Inria), Josselin Garnier (EP), Clément Gauchy (CEA), Luc Giraud (Inria), Stéphane Lanteri (Inria), Frédéric Nataf (CNRS), Isabelle Ramière (CEA), Thomas Saigre (UNISTRA), El-Ghazzali Talbi (U Lille)]}
...
%%% Change Log
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`'
\istChange{23/07/2026}{v2.90.0}{Christophe Prud'homme (UNISTRA)}{Integration draft for v3.0.0: retained the v2 WP hierarchy, added annual advance records and section update notes, reconciled application and benchmark registries, and integrated D7.3 training material into the mega-deliverable}
...
\istChange{13/10/2025}{v1.91.1}{Christophe Prud'homme (UNISTRA), Hélène Barucq (Inria), Isabelle Ramière(CEA), Pierre Alliez (Inria), Stéphane Lanteri(Inria), Emmanuel Franck(Inria), Frédéric Nataf(CNRS), Luc Giraud(Inria), Vincent Faucher (CEA), El-Ghazzali Talbi(U Lille), Victor Dansac(Inria) Josselin Garnier (EP), Clément Gauchy (CEA)}{Workpackage chapters contributed}
\istChange{10/07/2025}{v1.90.0}{Christophe Prud'homme (UNISTRA), Thomas Saigre (UNISTRA)}{Initial version 2 of the deliverable: table of contents}
