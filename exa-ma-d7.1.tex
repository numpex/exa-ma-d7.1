...
\delivNumber{D1.1;D2.1;D3.1;D4.1;D5.1;D6.1;D7.1;D7.3}
...
%%% Change Log
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%`'
\istChange{23/07/2026}{v2.90.0}{Christophe Prud'homme (UNISTRA)}{Integration draft for v3.0.0: retained the v2 WP hierarchy, added annual advance records and section update notes, reconciled application and benchmark registries, and integrated former D7.3 training material}
