...
In the table~\ref{tab:\VAR{wp}:\VAR{software.name}:features} we provide a summary of the software features relevant to the work package which are briefly discussed.
...
In the table~\ref{tab:\VAR{wp}:\VAR{software.name}:bottlenecks}, we briefly discuss the bottleneck roadmap associated to the software and relevant to the work package.
